...
app.get("/guestbook", (req, res) => {
    ...
    let results ="<header style = 'background-color: rgba(29, 28, 28, 0.89)' ><nav><a href='/'>Home</a>" +""+ "<a href='/guestbook'>Guestbook</a>"+""+"<a href='/newmessage'>Message</a>"+""+"<a href='/ajaxmessage'>Ajax</a></nav></header>"+
